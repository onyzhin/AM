<div class="firstScreen">
	...
	<div class="container firstScreen-text ctext">
		...
		в долгосрочном периоде  на волатильности фондовых и валютных рынков.</p>
		<p><b>Фонд инвестирует</b> в акции, валюты, а временно свободные  денежные средства 
		инвестирует в облигации.</p>
	</div>
</div>
<div class="main">
	<div class="chart">
		<div class="container">
			<div class="chart-list">
				<div class="chart-item">
					<div class="chart-title">График <br> стоимости пая</div>
					<div class="chart-box">
						...
						<div class="chart-box-footer">
							...
							<div class="chart-box-info">
								...
								<div class="chart-box-percent">(-18.77%)</div>
							</div>
						</div>
					</div>
				</div>
				<div class="chart-item">
					<div class="chart-title">График <br> СЧА</div>
					<div class="chart-box">
						<div class="chart-box-axes"><img src="images/chart-2.png" alt=""></div>
					</div>
				</div>
			</div>
		</div>
